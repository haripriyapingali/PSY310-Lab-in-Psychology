...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/haripriya/Downloads/intentional binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=5.0, method='random', 
        ...
        trialList=data.importConditions('/Users/haripriya/Downloads/ib_cons.xlsx'),
    ...
    for thisTrial in trials:
        ...
        trialComponents = [polygon, polygon_2, key_resp, textbox_2]
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('loop.started', globalClock.getTime(format='float'))
        sound_1.setSound(freq, secs=0.3, hamming=True)
        sound_1.setVolume(1.0, log=False)
        sound_1.seek(0)
        # keep track of which components have finished
        loopComponents = [sound_1]
        ...
        for thisComponent in loopComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('loop.stopped', globalClock.getTime(format='float'))
