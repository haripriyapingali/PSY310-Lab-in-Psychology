...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/haripriya/visual search task _lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        # Decide number of distractors based on a random condition
        if random() > 0.5:
            num_distr = 10
        else:
            num_distr = 5
        
        # Add the number of distractors to the experiment data
        thisExp.addData('num_distr', num_distr)
        
        # Initialize distractors list
        distractors = []
        
        # Create distractors based on the number specified
        for i in range(num_distr):
            distr = visual.TextStim(win=win, name='distr',
                text='L',
                font='Arial',
                pos=(random() - 0.5, random() - 0.5),  # Random position
                height=0.05, wrapWidth=None, 
                ori=randint(1, 360),  # Random orientation
                color='white', colorSpace='rgb', opacity=None, 
                languageStyle='LTR',
                depth=-2.0)
        ...
        # Set all distractors to be automatically drawn
        ...
        # Assuming 'distractors' is a list of distractor stimuli
        for distr in distractors:
            distr.setAutoDraw(False)  # Stop drawing each distractor
